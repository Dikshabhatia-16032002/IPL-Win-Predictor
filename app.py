...
# If you're also seeing ConvergenceWarnings, you can ignore them like this:
...
pipe = pickle.load(open('D:/project 6th sem/IPL_win_predictor-machine-learning--master/pipe.pkl','rb'))
